...
curl -sL "https://github.com/LuaLS/lua-language-server/releases/download/${VERSION}/lua-language-server-${VERSION}-linux-${arch}.tar.gz" -o lua-language-server.tar.gz
